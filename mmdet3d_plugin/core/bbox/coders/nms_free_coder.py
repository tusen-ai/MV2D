...
class NMSFreeCoder(BaseBBoxCoder):
    ...
    def decode_batch(self, bbox_preds):
        return denormalize_bbox(bbox_preds, None)

    def decode_single(self, cls_scores, bbox_preds, sigmoid_cls=False):
        """Decode bboxes.
        Args:
        ...
        max_num = min(max_num, cls_scores.numel())
    ...
    def decode(self, preds_dicts, sigmoid_cls=False):
        """Decode bboxes.
        Args:
        ...
        for i in range(batch_size):
            predictions_list.append(self.decode_single(cls_scores[i], bbox_preds[i], sigmoid_cls=sigmoid_cls))
